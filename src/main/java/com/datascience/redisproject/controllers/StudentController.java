...
public class StudentController {
    ...
    @ApiOperation(value = "Delete all students ", response = Student.class)
    @DeleteMapping
    ...
    @ApiOperation(value = "Get  students by name", response = Student.class)
    ...
    @ApiOperation(value = "Get students by age", response = Student.class)
    @GetMapping("/age/{age}")
    ...
    @ApiOperation(value = "Update student name", response = Student.class)
    @PutMapping("/{id}/name")
    ...
    @ApiOperation(value = "Get a student by age", response = Student.class)
    @PutMapping("/{id}/age")
    ...
    @ApiOperation(value = "Get a student by areaCode", response = Student.class)
    ...
    @ApiOperation(value = "Get all students by atribute", response = Student.class)
    ...
    @ApiOperation(value = "Get a student by graduationTitle", response = Student.class)
